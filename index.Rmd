...
This course was developed by Ben Weinstein (2014), Mike McCann (2015), and Nicole Kinlock (2016, 2017) to be a workshop held by the Department of Ecology & Evolution at Stony Brook University
...
- Part 2: <a href = "#/44"> Probability </a>
- Part 3: <a href = "#/63"> Data manipulation </a>
- Part 4: <a href = "#/96"> Looping and vectorization </a>
- Part 5: <a href = "#/132"> Functions </a>
- Part 6: <a href = "#/147"> Data visualization using ggplot2 </a>
...
3. Is 9 to the fourth power equal to the sum of 2000 and 187 multiplied by 3?
...
- Do not use <b>`a = 12 + 180`</b> for assignment in R. It's best practice to use `<-` instead of `=`.

- This is arbitrary, but a convention in R (the reasoning is that `<-` maintains backwards compatibility with S-Plus)

- But, it is good to follow conventions -- this makes your code more readable
...
<b>Use `#` signs to comment on your script.</b> Anything to the right of a `#` is ignored. Good scripts have comments before every major block of code. It's surprisingly hard to remember what you did when reviewing older code, and it's particularly important when other people are reading your code.  
...
1. We have a repeated process with identical formatting, but different values.
...
3. Create a for loop that adds 1 to numbers 1 through 5.
